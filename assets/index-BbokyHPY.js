...
aut aut aut maxime quia temporibus ut omnis`}],Pc=({user:e})=>j.jsx("a",{className:"UserInfo",href:`mailto:${e.email}`,children:e.name}),Lc=({comment:e})=>j.jsxs("div",{className:"CommentInfo",children:[j.jsxs("div",{className:"CommentInfo__title",children:[j.jsx("strong",{className:"CommentInfo__name",children:e.name})," by ",j.jsx("a",{className:"CommentInfo__email",href:`mailto:${e.email}`,children:e.email})]}),j.jsx("div",{className:"CommentInfo__body",children:e.body})]}),Tc=({comments:e})=>j.jsx("div",{className:"CommentList",children:e.map(t=>j.jsx(Lc,{comment:t},t.id))}),Mc=({post:e})=>j.jsxs("div",{className:"PostInfo",children:[j.jsxs("div",{className:"PostInfo__header",children:[j.jsx("h3",{className:"PostInfo__title",children:e.title}),j.jsxs("p",{children:[" Posted by  ",j.jsx(Pc,{user:e.user})]})]}),e.comments.length>0?j.jsx(Tc,{comments:e.comments}):j.jsxs(j.Fragment,{children:[j.jsx("hr",{}),j.jsx("b",{"data-cy":"NoCommentsMessage",children:"No comments yet"})]})]}),Rc=({posts:e})=>j.jsx("div",{className:"PostList",children:e.map(t=>j.jsx(Mc,{post:t},t.id))}),Dc=Cc.map(e=>({...e,user:zc.find(t=>t.id===e.userId),comments:Nc.filter(t=>t.postId===e.id)})),jc=()=>j.jsxs("section",{className:"App",children:[j.jsx("h1",{className:"App__title",children:"Static list of posts"}),j.jsx(Rc,{posts:Dc})]});em(document.getElementById("root")).render(j.jsx(jc,{}));
